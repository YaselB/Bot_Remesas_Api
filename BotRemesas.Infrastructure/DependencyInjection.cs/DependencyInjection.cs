...
public static class DependencyInjection
{
    ...
    {
        services.AddDbContext<BotRemesasDbContext>(options => options.UseNpgsql("Host=yamanote.proxy.rlwy.net;Port=10173;Database=railway;Username=postgres;Password=WBnpLAiTBMjkKwgDcVNdHbLnUdiMALly", b => b.MigrationsAssembly(typeof(BotRemesasDbContext).Assembly.FullName)));
