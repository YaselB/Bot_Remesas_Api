...
public static class DependencyInjection
{
    ...
    {
        services.AddDbContext<BotRemesasDbContext>(options => options.UseNpgsql("Host=postgres.railway.internal;Port=5432;Database=railway;Username=postgres;Password=WBnpLAiTBMjkKwgDcVNdHbLnUdiMALly", b => b.MigrationsAssembly(typeof(BotRemesasDbContext).Assembly.FullName)));
